...
*
* v0.tidoust
*  Fixed to work with CSS style sheets that do not define any rules
*  (Google Web Fonts actually return such style sheets because they only contain
*  a @font-face directive)
*  Fixed to work with images that return an error
*  (CSS libraries may reference unused images)
*
* v0.95
